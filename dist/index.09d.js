...
return webpackJsonpMyLibrary([0],[
/* 0 */
...
/* WEBPACK VAR INJECTION */(function($) {function _Carousel($ct, imgArray) {
    this.$ct = $ct;
    this.imgArray = imgArray;

    debugger;

    //如果传入图片src数组，则用该数组渲染出图片
    if (imgArray) {
        this.renderImg();
        this.renderBullet();
    }
...
_Carousel.prototype = {
    ...
    renderImg: function () {
        for (let i = 0; i < this.imgArray.length; i++) {
            let $imgLi = $('<li><a href=""><img src="' + this.imgArray[i] + '" alt=""></a></li>');
            this.$ct.find('.img-ct').append($imgLi);
        }
    },
    ...
    renderBullet: function () {
        ...
        for (let i = 0, len = this.imgArray.length; i < len; i++) {
            let bulletLi = $('<li><a href="#"></a></li>');
            bulletCt.append(bulletLi);
        }
    }
};

module.exports = {
    init: function ($cts, imgArray) {
        $cts.each(function (index, node) {
            new _Carousel($(node), imgArray);
        });
    }
...
/* WEBPACK VAR INJECTION */(function($) {function GoTo($ct, $target, text) {
    this.$ct = $ct;
    this.$target = $target;
    this.text = text;
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__waterFall__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__waterFall___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__waterFall__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__exposure__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__exposure___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__exposure__);
...
function SinaNews($ct, $item, $loadMore, perPageCount) {
    ...
    //初始化waterFall对象
    this.selfWaterFall = __WEBPACK_IMPORTED_MODULE_0__waterFall___default.a.init(this.$ct, this.$item);

    let _this = this;
    //初始化曝光加载对象
    this.selfExposure = __WEBPACK_IMPORTED_MODULE_1__exposure___default.a.init(this.$loadMore, function () {
        _this.getNews();
    });
...
SinaNews.prototype.place = function (data) {
    ...
    $.when.apply(null, defereds).done(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0__waterFall___default.a.waterFallRender(_this.selfWaterFall, $nodes);
    });
};
...
/* WEBPACK VAR INJECTION */(function($) {function Exposure($target, callback) {
    this.$target = $target;
...
/* WEBPACK VAR INJECTION */(function($) {function WaterFall($ct, $item) {
    //瀑布流容器
    this.$ct = $ct;
    //瀑布流中的单个块元素item
    this.$item = $item;
...
$(function () {
    ...
    var goTo = __webpack_require__(2);
    goTo.init($('body'), $('.carousel').eq(0), 'Go Top');

    var sinaNews = __webpack_require__(3);
...
//# sourceMappingURL=index.09d.js.map